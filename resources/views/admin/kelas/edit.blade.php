            ...
            <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden h-fit">
                ...
                <div class="px-6 py-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_kelas" value="{{ old('nama_kelas', $kelas->nama_kelas) }}" id="inp_nama"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="time" name="jam_mulai" value="{{ old('jam_mulai', $kelas->jam_mulai) }}" id="inp_jam_mulai"
                        ...
                        <div>
                            ...
                            <input type="time" name="jam_selesai" value="{{ old('jam_selesai', $kelas->jam_selesai) }}" id="inp_jam_selesai"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="3"
                            class="w-full text-sm border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary-300 transition resize-none">{{ old('deskripsi', $kelas->deskripsi) }}</textarea>
                    </div>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="text-center">
                            <p id="prev_nama" class="font-bold text-gray-800 text-base">{{ $kelas->nama_kelas }}</p>
                            <p id="prev_guru" class="text-xs text-gray-400 mt-0.5">{{ $kelas->guru->nama ?? '—' }}</p>
                            <p id="prev_harga" class="text-sm text-primary-700 font-semibold mt-1">
                                Rp {{ number_format($kelas->harga_kelas, 0, ',', '.') }} / bulan
                            </p>
                        </div>
                        <div class="flex justify-center gap-2 text-xs text-gray-500">
                            <span><i class="fa-solid fa-clock mr-1 text-gray-400"></i>
                                <span id="prev_jam">{{ $kelas->jam_mulai }} – {{ $kelas->jam_selesai }}</span>
                            </span>
                        </div>
                        <div>
                            ...
                            <div id="prev_hari" class="flex flex-wrap gap-1 justify-center">
                                @foreach($oldHari as $h)
                                    <span class="text-xs font-semibold px-2.5 py-1 rounded-full {{ $hariColorPreview[trim($h)] ?? 'bg-gray-100 text-gray-600' }}">
                                        {{ trim($h) }}
                                    </span>
                                @endforeach
                            </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                    <div class="flex items-center gap-2 mb-3">
                        <div class="w-1 h-5 bg-primary-700 rounded-full"></div>
                        <h3 class="text-sm font-bold text-gray-700">Info Kelas</h3>
                    </div>
                    <div class="space-y-2">
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-500 text-xs">Jumlah Peserta</span>
                            <span class="font-semibold text-gray-800">{{ $kelas->jumlah_peserta ?? 0 }} orang</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-500 text-xs">Dibuat</span>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 space-y-3">
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-save"></i> Update Kelas
                    </button>
                    <a href="{{ route('admin.kelas.index') }}"
