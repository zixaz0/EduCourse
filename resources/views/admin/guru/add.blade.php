...
@section('content')
    ...
    <div class="mb-6">
        ...
        <h1 class="text-xl font-bold text-gray-800">Tambah Guru Baru</h1>
        <p class="text-sm text-gray-500 mt-0.5">Isi form berikut untuk menambah guru baru</p>
    </div>
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="flex items-center gap-3 px-6 py-4 bg-primary-700">
                    ...
                    <div>
                        <p class="text-white font-bold text-sm">Form Tambah Guru</p>
                ...
                <div class="px-6 py-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama" id="inp_nama" value="{{ old('nama') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="no_hp" id="inp_nohp" value="{{ old('no_hp') }}" required
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="jk-option flex items-center gap-3 border-2 border-gray-200 rounded-xl px-4 py-3 cursor-pointer transition hover:border-primary-300"
                                ...
                                <input type="radio" name="jenis_kelamin" value="laki-laki" class="hidden jk-radio"
                                    {{ old('jenis_kelamin') === 'laki-laki' || !old('jenis_kelamin') ? 'checked' : '' }}
            ...
            <div class="w-full lg:w-72 flex flex-col gap-4">
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="flex flex-col items-center gap-3 py-4">
                        <div id="prev_avatar" class="w-16 h-16 rounded-full bg-primary-100 flex items-center justify-center">
                            <span class="text-primary-700 font-bold text-2xl" id="prev_initial">?</span>
                        </div>
                        <div class="text-center">
                            <p class="font-semibold text-gray-800 text-sm" id="prev_nama">—</p>
                            <p class="text-xs text-gray-400 mt-0.5" id="prev_email">—</p>
                            <p class="text-xs text-gray-400 mt-0.5" id="prev_nohp">—</p>
                        </div>
                ...
                <button type="submit"
                    ...
                    <i class="fa-solid fa-floppy-disk"></i> Simpan Guru
                </button>
